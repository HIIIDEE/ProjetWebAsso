  ...
  return (
    <div className="group h-full">
      <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-primary-light overflow-hidden group-hover:scale-[1.02] h-full flex flex-col">
        {/* Icon Section */}
        <div className="relative h-32 sm:h-36 md:h-40 bg-gradient-to-br from-primary-light/10 to-accent/10 flex items-center justify-center overflow-hidden">
        ...
        <div className="p-4 sm:p-5 md:p-6 flex-1 flex flex-col">
          ...
          {/* Title */}
          <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-primary transition-colors line-clamp-2">
            {event.title}
          </h3>
          ...
          <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4">
            <div className="flex items-center">
              <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-2 text-primary flex-shrink-0" />
