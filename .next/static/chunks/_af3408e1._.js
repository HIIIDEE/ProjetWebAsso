...
const sendEventRegistration = async (formData, eventData)=>{
    try {
        // Sujet de l'email
        const emailSubject = "🎯 Nouvelle inscription - ".concat(eventData.title);
        // Corps de l'email
        const emailBody = "\nBonjour équipe ANDSI,\n\nUne nouvelle inscription a été effectuée via le site web.\n\n═══════════════════════════════════════════════════════\n📅 DÉTAILS DE L'ÉVÉNEMENT\n• Événement : ".concat(eventData.title, "\n• Date : ").concat(eventData.date, "\n• Lieu : ").concat(eventData.location, "\n• Type : ").concat(eventData.type, "\n\n═══════════════════════════════════════════════════════\n👤 INFORMATIONS DU PARTICIPANT\n• Nom complet : ").concat(formData.firstName, " ").concat(formData.lastName, "\n• Email : ").concat(formData.email, "\n• Téléphone : ").concat(formData.phone, "\n• Entreprise : ").concat(formData.company, "\n• Fonction : ").concat(formData.position, "\n• Expérience IT : ").concat(formData.experience || "Non renseigné", "\n\n═══════════════════════════════════════════════════════\n📋 INFORMATIONS COMPLÉMENTAIRES\n• Restrictions alimentaires : ").concat(formData.dietaryRestrictions || "Aucune", "\n• Motivations : ").concat(formData.motivation || "Non renseigné", "\n\n═══════════════════════════════════════════════════════\n📊 DÉTAILS DE L'INSCRIPTION\n• Date d'inscription : ").concat(new Date().toLocaleDateString("fr-FR"), "\n• Heure d'inscription : ").concat(new Date().toLocaleTimeString("fr-FR"), "\n• Navigateur : ").concat(navigator.userAgent, "\n\n---\nCette inscription a été générée automatiquement depuis le site web ANDSI.\nEmail de contact du participant : ").concat(formData.email, "\n\nMerci de confirmer la réception et l'inscription.\n\nCordialement,\nSystème d'inscription ANDSI\n    ").trim();
        // Crée le lien mailto vers ton adresse de réception
        const mailtoLink = "mailto:salimdjaffer.23@gmail.com?subject=".concat(encodeURIComponent(emailSubject), "&body=").concat(encodeURIComponent(emailBody));
...
;
;
const EventRegistrationModal = (param)=>{
    ...
    const handleDirectEmail = ()=>{
        const directMailto = "mailto:contact@andsi.dz?subject=Inscription ".concat(event.title, "&body=Bonjour, je souhaite m'inscrire à l'événement \"").concat(event.title, '" du ').concat(event.date, ".%0A%0AMes coordonnées :%0ANom: ").concat(formData.firstName, " ").concat(formData.lastName, "%0AEmail: ").concat(formData.email, "%0ATéléphone: ").concat(formData.phone, "%0AEntreprise: ").concat(formData.company, "%0A%0ACordialement.");
...
"[project]/components/layout/SiteWrapper.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function SiteWrapper(param) {
    let { children, maxWidth = "max-w-6xl" } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "".concat(maxWidth, " mx-auto px-6"),
        children: children
    }, void 0, false, {
...
_c = SiteWrapper;
var _c;
__turbopack_context__.k.register(_c, "SiteWrapper");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$SiteWrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/layout/SiteWrapper.js [app-client] (ecmascript)");
...
function Home() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$layout$2f$SiteWrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_af3408e1._.js.map